...
To build the NFT preview card component according to the given designs, and make it look as close as possible.  
The users should be able to:
- View the optimal layout depending on the users device's screen size
- See hover states for interactive elements _(NFT card image, title and author name in footer)_

### Links

- Solution URL: [Open GitHub repository](https://github.com/YariMorcus/nft-preview-card-component)
- Live Site URL: [open GitHub Pages of repository](https://yarimorcus.github.io/nft-preview-card-component/)
...
5. How to create an image overlay with a solid color
